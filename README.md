...
**Backend & data** - Python, FastAPI, PostgreSQL, Docker, Prometheus, Grafana, pytest

**ML & AI** - PyTorch, OpenCV, reinforcement learning, OCR and document pipelines
...
in a single pull request than any tutorial did.

### Currently

Finishing my engineering thesis - automated guitar source separation and polyphonic
transcription with fretboard-position optimisation.

Kraków, Poland · [LinkedIn](https://www.linkedin.com/in/milosz-gibala/)
